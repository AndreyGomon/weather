package ru.mascot.features.weather.provider.openMeteo
...
fun <T : Any> getSerialNames(kClass: kotlin.reflect.KClass<T>): List<String> {
    val map = kClass.memberProperties.map { property ->
